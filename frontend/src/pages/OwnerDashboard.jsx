        ...
        return (
          <div className="space-y-6 animate-fade-in pb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {violations
                .filter((v) => v.imageUrl || v.evidenceUrl)
                .map((v) => (
                  <div
                    key={v._id}
              ...
              {violations.filter((v) => v.imageUrl || v.evidenceUrl).length ===
                0 && (
        ...
        return (
          <div className="max-w-2xl mx-auto space-y-4 animate-fade-in">
            ...
            {notifications.map((n) => (
              <div
                key={n._id}
                className="bg-white border border-neutral-100 rounded-2xl p-6 flex items-center space-x-4 hover:border-primary-900/20 transition-all group">
          ...
          <div className="max-w-xl mx-auto space-y-8 animate-fade-in">
            <div className="bg-white border border-neutral-100 rounded-[40px] p-10 shadow-2xl space-y-8 border-l-8 border-primary-950">
              ...
              <form onSubmit={updateProfile} className="space-y-4 pt-4">
                ...
                {profileMsg && (
                  <p className="text-center text-2xs font-black uppercase text-accent-crimson italic animate-pulse">
                    {profileMsg}
                  </p>
                )}
              </form>
